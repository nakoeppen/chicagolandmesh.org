...
If you would like to contribute a shared build guide or improve an existing one, please follow these steps:
...
=== "Using GitHub directly"
    ...
    2. Create the file by clicking **Add file**, then **Create new file**. In the file name field paste in `docs/shared/builds/posts/<guide-name>.md`, replacing `<guide-name>` with the name of your guide in lowercase. Make sure to replace spaces with dashes
    <br>
...
=== "Using the command line"
    ...
    3. Create your guide in markdown format within the `docs/shared/builds/posts` folder using your favorite text editor. Replace `<guide-name>` with a short and descriptive name related to your guide
    ```bash
    vim docs/shared/builds/posts/<guide-name>.md # or your editor of choice
    ```

    4. Format your guide using [Markdown syntax](https://en.wikipedia.org/wiki/Markdown#Examples). You can view previous guides in `docs/shared/builds/posts/` for examples
